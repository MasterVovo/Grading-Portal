...
function sendEmail($id, $fname, $mname, $lname, $email, $pass) {
    ...
    We are delighted to welcome you to KLD's Grading Portal, your central hub for grading. Your login credentials are provided below:<br><br>
    ...
    $mail->Subject = 'Welcome to KLD Grading Portal';
    $mail->Body = $emailText;
